...
class cbsSocialAccess extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_cbssocialaccess';
	var $table_index= 'cbssocialaccessid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_cbssocialaccesscf', 'cbssocialaccessid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cbssocialaccess', 'vtiger_cbssocialaccesscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_cbssocialaccess'   => 'cbssocialaccessid',
	    'vtiger_cbssocialaccesscf' => 'cbssocialaccessid');
	...
	function vtlib_handler($modulename, $event_type) {
		if($event_type == 'module.postinstall') {
			...
			if ($modCmps) $modCmps->setRelatedList($module, 'cbsSocialAccess', Array('ADD'),'get_dependents_list');
			// TODO Handle post installation actions
			$this->setModuleSeqNumber('configure', $modulename, 'cbsSocial-', '0000001');
